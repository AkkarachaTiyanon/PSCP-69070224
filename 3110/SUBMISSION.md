...
```text
a question that make want get price from shipping to ต้นทาง - ปลายทาง and get base fee and weight fee
```
...
```text
i use table and make it check base price fee and weight fee and computing
```
