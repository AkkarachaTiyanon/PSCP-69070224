...
```text
if u are customer u get 5% sale but if u not and if u brought over 500 u get 3%
```
...
```text
i collect all price user purchased then check if it customer get 5% but if not and brought over 500 get 3$
```
