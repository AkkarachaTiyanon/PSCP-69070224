...
```text
a question that want get smallest brick amount that u need to after big brick is placed
```
...
```text
when user input then it want you get a final amount small brick that need to use
```
