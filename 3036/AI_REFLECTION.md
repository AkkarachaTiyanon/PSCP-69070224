...
|---|---|---|
| I read the relevant workflow before using AI. | Yes | Example: `workflows/STUDENT_WORKFLOW_WEB_CHAT.md`, `workflows/STUDENT_WORKFLOW_CHATGPT_CODEX.md`, `workflows/STUDENT_WORKFLOW_CLAUDE_CODE.md`, or another workflow announced by the instructor | Yes
...
```text
I asked AI to explain why my output was different from the expected output and i asked ai to find bug in my code
```
...
```text
new math isqrt how it work and a how the problem work and how is it solving
```
