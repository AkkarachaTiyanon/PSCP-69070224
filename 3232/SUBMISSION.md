...
```text
it want you compute if it can move in meter and is it able to reach goal distance
```
...
```text
get user input then compute a frog can walk and minus with 2 every step until it can reach if it cnanot reach make it -1
```
