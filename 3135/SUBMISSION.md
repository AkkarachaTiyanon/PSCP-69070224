...
```text
it will find how many count that a gift to others people will stopped
```
...
```text
it gonna get count make it repeat until gift is found self or found a stealer
```
