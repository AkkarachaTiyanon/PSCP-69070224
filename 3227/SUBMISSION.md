...
```text
it want output full of name spades like 10c it gonna be 10 of clubs
```
...
```text
slicing last char and get a number and make it check on list and print correct format
```
